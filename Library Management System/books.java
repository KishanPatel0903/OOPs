...
public class books {
    ...
    public void searchByCategory(){
        System.out.println("\t...SEARCH BY BOOK'S CATEGORY...\n\t\tPress Enter");
        input.nextLine();
    ...
    public void searchByTitle(){
        System.out.println("\t...SEARCH BY BOOK'S TITLE...\n\t\tPress Enter");
        input.nextLine();
        ...
        for (int i = 0; i < count; i++)
        {
            if (title.equalsIgnoreCase(theBooks[i].bookName)) {
                System.out.println(theBooks[i].sNo + "\t\t" + theBooks[i].bookName + "\t\t"
                        + theBooks[i].authorName + "\t\t" + theBooks[i].category + "\t\t");
                flag++;
            }
    ...
    public int sortbyauthor(){
        ...
        System.out.println("The books sorted by author name:");
        ...
        System.out.println("The books sorted by categories:");
        System.out.println(mp);
